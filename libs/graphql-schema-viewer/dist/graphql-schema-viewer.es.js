import de, { useState as B, useMemo as ce } from "react";
var z = { exports: {} }, W = {};
/*
object-assign
(c) Sindre Sorhus
...
const t = {
  ...
  var A, F, Q, V;
  const [m, O] = B(/* @__PURE__ */ new Set()), [a, g] = B(/* @__PURE__ */ new Set()), [b, s] = B(null), { operations: l, types: d } = ce(() => {
          ...
          if (q && !_ && f > 0 && (C = R.join(" ").trim(), q = !1), f > 0 && !_) {
            ...
            if (L) {
              ...
              c.push({
                ...
                type: v,
                description: re,
                parameters: M.length > 0 ? M : void 0,
      ...
      r && (((Q = r.endPoints) == null ? void 0 : Q.productionURL) || ((V = r.endPoints) == null ? void 0 : V.sandboxURL)) && /* @__PURE__ */ e.jsxs("div", { style: t.endpointsContainer, children: [
        r.endPoints.productionURL && /* @__PURE__ */ e.jsxs(
          "div",
          {
            ...
            title: "Click to copy",
            children: [
              /* @__PURE__ */ e.jsx("div", { style: { ...t.endpointIcon, ...t.endpointIconProduction }, children: /* @__PURE__ */ e.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
        ...
        r.endPoints.sandboxURL && /* @__PURE__ */ e.jsxs(
          "div",
          {
            ...
            title: "Click to copy",
            children: [
              /* @__PURE__ */ e.jsx("div", { style: { ...t.endpointIcon, ...t.endpointIconSandbox }, children: /* @__PURE__ */ e.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
                /* @__PURE__ */ e.jsx("path", { d: "M10 2L2 7L10 12L18 7L10 2Z", fill: "white" }),
                /* @__PURE__ */ e.jsx("path", { d: "M2 13L10 18L18 13", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }),
                /* @__PURE__ */ e.jsx("path", { d: "M2 10L10 15L18 10", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
              ] }) }),
