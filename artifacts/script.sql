...
DROP TABLE IF EXISTS "DP_API_FLOW_APIS";
...
CREATE TABLE IF NOT EXISTS "DP_API_FLOW" (
    ...
    UNIQUE ("API_FLOW_ID", "ORG_ID", "VIEW_ID"),
    FOREIGN KEY ("ORG_ID") REFERENCES "DP_ORGANIZATION"("ORG_ID") ON DELETE CASCADE,
    FOREIGN KEY ("VIEW_ID") REFERENCES "DP_VIEWS"("VIEW_ID") ON DELETE CASCADE
);
...
-- DP_API_FLOW_APIS: Many-to-many mapping between APIFlows and APIs
CREATE TABLE IF NOT EXISTS "DP_API_FLOW_APIS" (
    "ID" VARCHAR(256) NOT NULL,
    "API_FLOW_ID" VARCHAR(256) NOT NULL,
    "API_ID" VARCHAR(256) NOT NULL,
    "ORG_ID" VARCHAR(256) NOT NULL,
    "VIEW_ID" VARCHAR(256) NOT NULL,
    UNIQUE ("API_FLOW_ID", "API_ID"),
    PRIMARY KEY ("ID"),
    FOREIGN KEY ("API_FLOW_ID", "ORG_ID", "VIEW_ID") REFERENCES "DP_API_FLOW"("API_FLOW_ID", "ORG_ID", "VIEW_ID") ON DELETE CASCADE,
    FOREIGN KEY ("API_ID", "ORG_ID", "VIEW_ID") REFERENCES "DP_API_METADATA"("API_ID", "ORG_ID", "VIEW_ID") ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS "IDX_DP_API_FLOW_APIS_FLOW_ID" ON "DP_API_FLOW_APIS"("API_FLOW_ID");
CREATE INDEX IF NOT EXISTS "IDX_DP_API_FLOW_APIS_API_ID" ON "DP_API_FLOW_APIS"("API_ID");
