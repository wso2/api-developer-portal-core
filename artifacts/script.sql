...
CREATE TABLE "DP_API_METADATA" (
    ...
    "AGENT_VISIBILITY" VARCHAR(32) NOT NULL DEFAULT 'HIDDEN' CHECK ("AGENT_VISIBILITY" IN ('VISIBLE', 'HIDDEN')),
    FOREIGN KEY ("ORG_ID") REFERENCES "DP_ORGANIZATION"("ORG_ID") ON DELETE CASCADE,
...
ADD COLUMN IF NOT EXISTS "AGENT_VISIBILITY" VARCHAR(32) NOT NULL DEFAULT 'HIDDEN'
...
CREATE TABLE IF NOT EXISTS "DP_API_FLOW_APIS" (
    ...
    PRIMARY KEY ("ID"),
    FOREIGN KEY ("API_FLOW_ID") REFERENCES "DP_API_FLOW"("API_FLOW_ID") ON DELETE CASCADE,
    FOREIGN KEY ("API_ID") REFERENCES "DP_API_METADATA"("API_ID") ON DELETE CASCADE
);
